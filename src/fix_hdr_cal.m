...
%If hdr file starts with "D", use DPET calibration = 7.04074e+06
%If hdr file starts with "F", use F120 calibration = 6.44038e+06
           ...
           if strcmpi(fp_ext, '.hdr') == 1
               ...
               while ~feof(fin)
                   ...
                   elseif strcmpi(fp_name(1), 'F')
                       s = strrep(s, 'calibration_factor 1', 'calibration_factor 6.44038e+06');
                   end
                   fprintf(fout,'%s\n',s);
               end                        
                  fin = fclose(fin);
